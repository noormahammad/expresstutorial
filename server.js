...
app.get('/readfile', function(req,res,next){
    ...
    fs.readFile('./public/randomfile.txt',function(err,data){
        ...
        res.send("This is the File Contents: " + data.toString());
    });
});

//This writes and reads from a file
app.get('/writefile', function(req,res,next){
    
    fs.writeFile('./public/randomfile.txt',"some more random text",function(err){
        if(err) return console.error(err);        
    });

    fs.readFile('./public/randomfile.txt',function(err,data){
    if(err) return console.error(err);
    res.send("This is the file : " + data.toString());
});
...
//another middleware : File Not found error
